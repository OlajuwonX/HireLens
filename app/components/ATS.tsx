...
const ATS: React.FC<ATSProps> = ({ score, suggestions }) => {
  ...
  const subtitle =
    score > 74 ? "Great Job!" : score > 45 ? "Good Start" : "Needs Improvement";

  return (
    <div
      className={`bg-gradient-to-b from-teal-200 via-teal-100 to-gray-200 rounded-2xl shadow-md w-full p-6`}
    >

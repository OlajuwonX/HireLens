    ...
    <div className="space-y-1.5">
      {(
        ...
        <Button
          ...
          align="start"
          size="compact"
          onClick={close ? () => setTimeout(close, 0) : undefined}
        >
          <a
...
export function ResumeDesignControls({
  ...
  const pendingRef = useRef<ResumeDesignSelection | null>(null);
  ...
  const choose = useCallback(
    (patch: Partial<ResumeDesignSelection>) => {
      ...
      >
        <div className="space-y-3">
          ...
          <div className="space-y-1.5 border-t border-border pt-3">
            ...
            <DownloadLinks publicId={publicId} selection={selection} />
          </div>
        </div>
      </Popover>
